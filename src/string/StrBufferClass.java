...
public class StrBufferClass {
    public static void main(String[] args) {
         ...
         *
         * Класът StringBuffer е синхронизиран, потокобезопасен и се използва в многонишкови приложения. В тези приложения,
         * обектът от тип StringBuffer, може да се променя в различните нишки.
         *
         * Конструкторът на StringBuffer - без параметри, първоначално запазва в паметта място за 16 символа, но може да бъде
         * зададен и различен капацитет, чрез конструктор с параметър capacity.
         */


        // Създаване на инстанция на клас StringBuffer
        ...
        StringBuffer sb3 = new StringBuffer(text);
        ...
        // Добавяне в края на текстов обект, от тип StringBuffer - .append()
        ...
        // Ако дължината на StringBuffer се увеличи, тогава неговият низ се допълва в края с празни символи,
        // ако се намалява, тогава низът се съкращава. При задаване на дължина 0 се изтрива.
        sb3.setLength(12);
        System.out.println("Method .setCharAt(12) | " + sb3);
        sb3.setLength(0);
        System.out.println("Method .setCharAt(0)  | " + sb3);
